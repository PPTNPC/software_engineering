...
INSERT INTO `account` VALUES ('6', 'jiaxuan', 'jiaxuan', '贾轩', '1305451515', '15830376117', 'yy', '0');
INSERT INTO `account` VALUES ('7', '123', '111111', null, null, '15234234523', null, '0');
INSERT INTO `account` VALUES ('8', '111', '111111', null, null, '15234234523', null, '0');
...
INSERT INTO `authority` VALUES ('437', '3', '37');
INSERT INTO `authority` VALUES ('438', '3', '38');
INSERT INTO `authority` VALUES ('439', '3', '39');
INSERT INTO `authority` VALUES ('440', '3', '40');
INSERT INTO `authority` VALUES ('441', '3', '41');
INSERT INTO `authority` VALUES ('442', '3', '70');
INSERT INTO `authority` VALUES ('443', '3', '42');
INSERT INTO `authority` VALUES ('444', '3', '43');
INSERT INTO `authority` VALUES ('445', '3', '44');
INSERT INTO `authority` VALUES ('446', '3', '45');
INSERT INTO `authority` VALUES ('447', '3', '46');
INSERT INTO `authority` VALUES ('448', '3', '47');
INSERT INTO `authority` VALUES ('449', '3', '48');
INSERT INTO `authority` VALUES ('450', '3', '49');
INSERT INTO `authority` VALUES ('451', '3', '50');
INSERT INTO `authority` VALUES ('452', '3', '51');
INSERT INTO `authority` VALUES ('453', '3', '52');
INSERT INTO `authority` VALUES ('454', '3', '53');
INSERT INTO `authority` VALUES ('455', '3', '54');
INSERT INTO `authority` VALUES ('456', '3', '55');
INSERT INTO `authority` VALUES ('457', '3', '56');
INSERT INTO `authority` VALUES ('458', '3', '57');
INSERT INTO `authority` VALUES ('459', '3', '58');
INSERT INTO `authority` VALUES ('460', '3', '59');
INSERT INTO `authority` VALUES ('461', '3', '60');
INSERT INTO `authority` VALUES ('462', '3', '61');
INSERT INTO `authority` VALUES ('463', '3', '62');
INSERT INTO `authority` VALUES ('464', '3', '63');
INSERT INTO `authority` VALUES ('465', '3', '64');
INSERT INTO `authority` VALUES ('466', '3', '65');
INSERT INTO `authority` VALUES ('467', '3', '66');
INSERT INTO `authority` VALUES ('468', '3', '67');
INSERT INTO `authority` VALUES ('469', '3', '68');
INSERT INTO `authority` VALUES ('470', '3', '69');
...
INSERT INTO `book_order` VALUES ('15', '5', '6', '小明', '31012002522555', '13545455454', '2', '2019-01-21', '2019-01-22', '我会尽快赶来！', '2019-01-19 23:02:45');
INSERT INTO `book_order` VALUES ('16', '5', '10', '小明', '31012002522555', '13545455454', '0', '2019-01-21', '2019-01-23', '奢侈一把！', '2019-01-19 23:03:25');
INSERT INTO `book_order` VALUES ('17', '6', '10', 'jiaxuan', '1305451515', '15830376117', '1', '2019-04-01', '2019-04-30', '阿萨德撒', '2019-04-18 13:57:36');
INSERT INTO `book_order` VALUES ('18', '6', '10', 'jiaxuan', '1305451515', '15830376117', '0', '2019-04-01', '2019-04-07', '', '2019-04-18 21:41:10');
INSERT INTO `book_order` VALUES ('19', '6', '1', 'jiaxuan', '1305451515', '15830376117', '0', '2019-05-23', '2019-05-31', '', '2019-05-23 09:25:33');
INSERT INTO `book_order` VALUES ('20', '7', '1', '123', '21312312321', '15234234523', '0', '2022-05-13', '2022-05-02', '2', '2022-05-10 22:08:44');
INSERT INTO `book_order` VALUES ('21', '8', '1', '111', '21312312321', '15234234523', '0', '2022-05-13', '2022-05-10', '问问', '2022-05-10 22:12:51');
...
CREATE TABLE `checkin` (
  ...
  `createTime` datetime NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `accountId` (`roomId`) USING BTREE,
  KEY `roomTypeId` (`roomTypeId`) USING BTREE,
...
INSERT INTO `checkin` VALUES ('13', '6', '6', '200.00', '小明', '31012002522555', '13545455454', '1', '2019-01-21', '2019-01-22', '15', '我会尽快赶来！', '2019-01-19 23:08:57');
...
INSERT INTO `checkin` VALUES ('24', '3', '10', '5555.00', 'jiaxuan', '1305451515', '15830376117', '0', '2019-04-01', '2019-04-30', '17', '阿萨德撒', '2019-04-18 14:02:17');
...
INSERT INTO `floor` VALUES ('12', '9楼', '正常');
...
INSERT INTO `log` VALUES ('74', '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-04-18 13:58:26');
INSERT INTO `log` VALUES ('75', '登录时，用户名为jiaxuan的用户不存在!', '2019-04-18 21:41:54');
INSERT INTO `log` VALUES ('76', '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-04-18 21:42:20');
INSERT INTO `log` VALUES ('77', '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-04-19 14:47:34');
INSERT INTO `log` VALUES ('78', '用户名为{jiaxuan}，角色为{前台}的用户登录成功!', '2019-05-19 21:08:09');
INSERT INTO `log` VALUES ('79', '用户名为{jiaxuan}，角色为{前台}的用户登录成功!', '2019-05-19 21:50:51');
INSERT INTO `log` VALUES ('80', '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-05-19 22:01:28');
INSERT INTO `log` VALUES ('81', '用户名为{jiaxuan}，角色为{前台}的用户登录成功!', '2019-05-23 09:07:27');
INSERT INTO `log` VALUES ('82', '用户名为{jiaxuan}，角色为{超级管理员}的用户登录成功!', '2019-05-23 09:11:32');
INSERT INTO `log` VALUES ('83', '用户名为{jiaxuan}，角色为{超级管理员}的用户登录成功!', '2019-05-23 09:13:59');
INSERT INTO `log` VALUES ('84', '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2022-05-10 22:09:23');
INSERT INTO `log` VALUES ('85', '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2022-05-10 22:15:21');
...
INSERT INTO `menu` VALUES ('70', '0', 'gg', 'xzzx', 'icon-bricks');
...
INSERT INTO `role` VALUES ('3', '前台', '酒店前台工作人员');
...
-- Records of room
-- ----------------------------
INSERT INTO `room` VALUES ('2', '/resources/upload/1558574648954.jpg', '1001', '1', '1', '1', '1001单人间、1楼。1111');
INSERT INTO `room` VALUES ('3', '/resources/upload/1558574643240.jpg', '2001', '2', '2', '1', '2楼普通大床房');
INSERT INTO `room` VALUES ('4', '/resources/upload/1558574637513.jpg', '3001', '3', '3', '2', '3001豪华大床房');
INSERT INTO `room` VALUES ('5', '/resources/upload/1558574631669.jpg', '4001', '4', '4', '0', '商务大床房');
INSERT INTO `room` VALUES ('6', '/resources/upload/1558574614225.jpg', '5001', '6', '5', '2', '豪华标准房');
...
-- ----------------------------
INSERT INTO `room_type` VALUES ('1', '单人间', '/resources/upload/1558574592698.jpg', '168.00', '1', '1', '12', '7', '4', '1', '1', '单人间只能入住一个人，大概15平米左右！');
INSERT INTO `room_type` VALUES ('2', '普通大床房', '/resources/upload/1558574578336.jpg', '299.00', '2', '1', '15', '15', '0', '0', '0', '普通大床房，面积25平左右！');
INSERT INTO `room_type` VALUES ('3', '豪华大床房', '/resources/upload/1558574520644.jpg', '399.00', '2', '1', '8', '8', '0', '0', '1', '豪华大床房，面积30平左右！');
INSERT INTO `room_type` VALUES ('4', '商务大床房', '/resources/upload/1558574513990.jpg', '429.00', '2', '1', '10', '10', '0', '0', '1', '商务大床房，面积40平左右！');
INSERT INTO `room_type` VALUES ('5', '普通标准间', '/resources/upload/1558574508276.jpg', '199.00', '2', '2', '11', '11', '0', '0', '1', '普通标准房，面积20平左右！');
INSERT INTO `room_type` VALUES ('6', '豪华标准房', '/resources/upload/1558574502398.jpg', '199.00', '2', '2', '10', '10', '0', '0', '1', '豪华标准房，面积30平左右！');
INSERT INTO `room_type` VALUES ('7', '商务标准间', '/resources/upload/1558574496287.jpg', '299.00', '2', '2', '10', '10', '0', '0', '1', '商务标准间，面积35平左右！');
INSERT INTO `room_type` VALUES ('8', '普通套房', '/resources/upload/1558574487679.jpg', '699.00', '2', '2', '6', '6', '0', '0', '1', '普通套房，面积50平左右！');
INSERT INTO `room_type` VALUES ('9', '豪华套房', '/resources/upload/1558574480398.jpg', '899.00', '2', '2', '5', '5', '0', '0', '1', '豪华套房，面积70平左右！');
INSERT INTO `room_type` VALUES ('10', '总统套房', '/resources/upload/1558574440975.jpg', '1299.00', '2', '2', '4', '1', '3', '1', '0', '总统套房，面积100平，超豪华！');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'admin', 'admin', '1', '/resources/upload/1652192140553.png', '1', '1', '上海市浦东新区浦东南路1835号');
INSERT INTO `user` VALUES ('14', 'wangbuer', 'wangbuer', '1', '/resources/upload/1555656815565.jpg', '1', '22', '洒洒水');
